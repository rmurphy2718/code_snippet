...
def command_runner(c):
    print("about to run a subprocess")
    print(c)
...
class Worker:
        ...
        while True:
            ...
            try:
                ...
                macro_dict = {
                    ...
                    "##GPU##": gpu_id,
                    "##SCRIPT##": "beaches_run/run.sh",
                    "##IDX##": str(ix),

                }
                print("HELLO WORKING DIR STUFF\n\n\n\n")
    ...
    def init(cls):
        ...
        rds = redis.Redis("leblon.cs.purdue.edu", 16379,
                          password='bc7a102fb51acd91f33fbac48ec801e392fabe6ece4cbaf982cf3e8c0604eecb')
